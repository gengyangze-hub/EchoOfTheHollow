namespace EchoesOfTheHollow
{
    ...
    public class ModConfig
    {
        ...
        public bool EnableShopGoodwill { get; set; } = true;        // Require goodwill for shop items
        public int MaxDailyShopRequests { get; set; } = 3;           // Max items per day from all shops
        public float GoodwillCostMultiplier { get; set; } = 0.01f;   // Vanilla price × multiplier = goodwill cost
        public bool ShowGoodwillCost { get; set; } = true;           // Show goodwill cost in shop tooltip
